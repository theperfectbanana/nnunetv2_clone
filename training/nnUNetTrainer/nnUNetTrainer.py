...
from nnunetv2.training.loss.compound_losses import DC_and_CE_loss, DC_and_BCE_loss, DC_and_MSE_loss
from nnunetv2.training.loss.deep_supervision import DeepSupervisionWrapper
from nnunetv2.training.loss.dice import get_tp_fp_fn_tn, MemoryEfficientSoftDiceLoss, MemoryEfficientMSELoss
...
class nnUNetTrainer(object):
    ...
    def _build_loss(self):
        if self.label_manager.has_regions:
            ...
            # print('_build_loss')
            # print(self.label_manager.ignore_label)
            loss = DC_and_MSE_loss(
                mse_kwargs={'apply_nonlin': None, 'batch_mse': self.configuration_manager.batch_dice,
                            'ddp': self.is_ddp},
                soft_dice_kwargs={'batch_dice': self.configuration_manager.batch_dice, 'smooth': 1e-5, 'do_bg': False,
                                  'ddp': self.is_ddp},
                weight_mse=1,
                weight_dice=0,
                use_ignore_label=self.label_manager.ignore_label is not None,
    ...
    def on_epoch_end(self):
        ...
        # print(self.logger.my_fantastic_logging['train_losses'][-1])
    ...
    def run_training(self):
        ...
        for epoch in range(self.current_epoch, self.num_epochs):
            ...
            for batch_id in range(self.num_iterations_per_epoch):
                # print(next(self.dataloader_train))
